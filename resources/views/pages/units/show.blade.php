                        ...
                        <div class="mt-6 space-y-3">
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                @if ($unit->contact_whatsapp)
                                    @php
                                        $unitWhatsappDigits = \App\Models\Setting::normalizeWhatsappPhone($unit->contact_whatsapp);
                                    @endphp
                                    @if ($unitWhatsappDigits)
                                        <a href="https://wa.me/{{ $unitWhatsappDigits }}" target="_blank" class="inline-flex items-center gap-2 px-4 py-3 rounded-xl bg-green-500 hover:bg-green-600 transition text-white text-sm font-medium">
