...
<div class="space-y-6">
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-2xl font-bold text-secondary-900 dark:text-secondary-50">{{ app()->getLocale() === 'ar' ? 'تعديل منطقة شحن' : 'Edit Shipping Zone' }}</h1>
    </div>

    <form action="{{ route('admin.shipping-zones.update', $shippingZone) }}" method="POST" class="card p-6">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input class="form-input" name="name_ar" value="{{ old('name_ar', $shippingZone->name_ar) }}" required />
                ...
                <div>
                    ...
                    <input class="form-input" name="name_en" value="{{ old('name_en', $shippingZone->name_en) }}" required />
                ...
                <div>
                    ...
                    <input class="form-input" name="governorate_ar" value="{{ old('governorate_ar', $shippingZone->governorate_ar) }}" />
                ...
                <div>
                    ...
                    <input class="form-input" name="governorate_en" value="{{ old('governorate_en', $shippingZone->governorate_en) }}" />
                ...
                <div>
                    ...
                    <input type="number" step="0.01" class="form-input" name="shipping_cost" value="{{ old('shipping_cost', $shippingZone->shipping_cost) }}" required />
                ...
                <div>
                    ...
                    <input type="number" class="form-input" name="estimated_days" value="{{ old('estimated_days', $shippingZone->estimated_days) }}" required />
                ...
                <div>
                    ...
                    <input type="number" class="form-input" name="order" value="{{ old('order', $shippingZone->order) }}" />
                    @error('order') <div class="text-sm text-red-600 mt-1">{{ $message }}</div> @enderror
                </div>

                <div class="flex items-center">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $shippingZone->is_active) ? 'checked' : '' }} class="form-checkbox" />
