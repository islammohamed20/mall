        ...
        <form class="mt-8 admin-card p-6 space-y-6" method="POST" action="{{ route('admin.shops.store') }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input class="form-input" name="owner_email" value="{{ old('owner_email') }}" placeholder="{{ app()->getLocale() === 'ar' ? 'للإشعارات واستلام الطلبات' : 'For notifications & receiving orders' }}" />
