...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
    ...
    <body class="min-h-screen bg-gray-50 text-secondary-900 dark:bg-secondary-950 dark:text-secondary-100 {{ $seasonThemeBodyClass ?? '' }}">
        @include('partials.season-banner')
        ...
        @php
            $whatsappNumber = \App\Models\Setting::getValue('mall_contact_whatsapp');
            $whatsappDigits = \App\Models\Setting::normalizeWhatsappPhone($whatsappNumber);
        @endphp
        @if($whatsappDigits)
            <div x-data="{ tooltip: false }">
                ...
                >
                    ...
                    <div 
                        ...
                        class="absolute ltr:left-full rtl:right-full ltr:ml-3 rtl:mr-3 top-1/2 -translate-y-1/2 px-3 py-2 bg-secondary-800 text-white text-sm rounded-lg whitespace-nowrap shadow-lg pointer-events-none"
                    >
